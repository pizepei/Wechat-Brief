 ...
 */
    ...
    namespace pizepei\WechatBrief\Module\Keyword;
        ...
        function chat($template_Type,$fromUsername,$toUsername,$time,$type,$content,$news_content,$content_keyword,$recognition)
        {
            ...
            switch($type)
            {
                case 'text'://文字回复
                    ...
                    Gateway::$registerAddress = '104.168.30.225:1238';
//                    var d = '{"emit":"gchat","sender_id":"'+client_id+'","sender_name":"'+name+'","content":"我上线了"}';
...
//                        'content' =>$fromUsername,
                        ...
                        'content' => json_encode(func::get_user_info($fromUsername)),
                        ];
//                    json_encode(func::get_user_info($fromUsername[1]));
